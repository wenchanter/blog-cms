  ...
  const handleUpload = async (files: File[]) => {
    ...
    if (urls.length > 0) {
      ...
      if (isValidPosition(pos)) {
        // LOCAL MODIFICATION: upstream captions every image with its
        // filename. The article page renders `alt` as the visible figcaption,
        // so "screenshot-2026" would leak into the published post. Start empty
        // and let the author write a caption in the node view.
